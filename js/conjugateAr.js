        ...
        <div class="conjugation-columns">
            ...
            <div class="column">
                ...
                <table class="conjugation-table">
                    ...
                    <tr class="row"><td class="pronoun">Eyos/as</td><td class="form">estavan ${stem}<span class="ending">an</ando></td></tr>
                </table>
            </div>
            ...
            <div class="column">
                ...
                <table class="conjugation-table">
                    ...
                    <tr class="row"><td class="pronoun">Eyos/as</td><td class="form">tenen ${stem}<span class="ending">an</ado></td></tr>
                </table>
            </div>

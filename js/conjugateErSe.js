        ...
        <div class="conjugation-columns">
            <div class="column">
                ...
                <table class="conjugation-table">
                    ...
                    <tr><td class="pronoun">El/eyTu</td><td>${pronouns[2]}</td><td class="form">esta ${stem}<span class="ending">iendo</span></td></tr>
            ...
            <div class="column">
                ...
                <table class="conjugation-table">
                    ...
                    <tr><td class="pronoun">El/eyTu</td><td>${pronouns[2]}</td><td class="form">estava ${stem}<span class="ending">iendo</span></td></tr>
                    ...
                    <tr><td class="pronoun">Eyos/as</td><td>${pronouns[5]}</td><td class="form">estavan ${stem}<span class="ending">an</iendo></td></tr>
                </table>
            </div>
            ...
            <div class="column">
                ...
                <table class="conjugation-table">
                    ...
                    <tr><td class="pronoun">El/eyTu</td><td>${pronouns[2]}</td><td class="form">tiene ${stem}<span class="ending">ido</span></td></tr>
                    ...
                    <tr><td class="pronoun">Eyos/as</td><td>${pronouns[5]}</td><td class="form">tenen ${stem}<span class="ending">an</ado></td></tr>
                </table>
            </div>
            ...
            <div class="column">
                ...
                <table class="conjugation-table">
                    ...
                    <tr><td class="pronoun">El/eyTu</td><td>${pronouns[2]}</td><td class="form">aviya ${stem}<span class="ending">ido</span></td></tr>
            ...
            <div class="column">
                ...
                <table class="conjugation-table">
                    ...
                    <tr><td class="pronoun">El/eyTu</td><td>${pronouns[2]}</td><td class="form">va ${verb}</td></tr>

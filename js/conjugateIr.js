    ...
    <div class="conjugation-section">
        ...
        <div class="conjugation-columns">
            ...
            <div class="column">
                ...
                <table class="conjugation-table">
                    <tr><td class="pronoun">Yo</td><td class="form">${stem}<span class="ending">iriya</span></td></tr>
                    <tr><td class="pronoun">Tu</td><td class="form">${stem}<span class="ending">iriyas</span></td></tr>
                    <tr><td class="pronoun">El/eya</td><td class="form">${stem}<span class="ending">iriya</span></td></tr>
                    <tr><td class="pronoun">Mozotros/as</td><td class="form">${stem}<span class="ending">iriyamos</span></td></tr>
                    <tr><td class="pronoun">Vozotros/as</td><td class="form">${stem}<span class="ending">iriyash</span></td></tr>
                    <tr><td class="pronoun">Eyos/as</td><td class="form">${stem}<span class="ending">iriyan</span></td></tr>
                </table>
            </div>
        </div>
        ...
        <div class="conjugation-columns">
            ...
            <div class="column">
                ...
                <table class="conjugation-table">
                    ...
                    <tr><td class="pronoun">Eyos/as</td><td class="form">estavan ${stem}<span class="ending">iendo</span></td></tr>
                </table>
            </div>
            ...
            <div class="column">
                ...
                <table class="conjugation-table">
                    ...
                    <tr><td class="pronoun">Eyos/as</td><td class="form">tenen ${stem}<span class="ending">ido</span></td></tr>
                </table>
            </div>
